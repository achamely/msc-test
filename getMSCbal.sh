...
echo "Bypassing mastercoin-explorer.com (offline)"
...
# Check consensus
#if [ `echo "$bal1 == $bal2" | bc` ] && [ `echo "$bal1 == $bal3" | bc` ] && [ `echo "$bal1 == $bal4" | bc` ] && [ `echo "$bal2 == $bal3" | bc` ] && [ `echo "$bal2 == $bal4" | bc` ] && [ `echo "$bal3 == $bal4" | bc` ]
if [ `echo "$bal1 == $bal3" | bc` ] && [ `echo "$bal1 == $bal4" | bc` ] &&  [ `echo "$bal3 == $bal4" | bc` ]
then
